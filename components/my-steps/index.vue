<template>
	<view class="container">
		<view class="set_box" v-for="(item,index) in talk" :key="index">
			...
			<view class="set-1">
				<view class="set-2">
					<view class="flex lihe-hight">
						<view class="mr-3">申请科室：儿科门诊</view>
						<view>申请病区：日间门诊</view>
					</view>
					<view>
						<view class="lihe-hight">床号：30号</view>
					</view>
					<view>
						<view class="lihe-hight">检查项目：耳区</view>
					</view>
					<view>
						<view class="lihe-hight flex info">
							<text style="font-size: 21rpx;">信息说明</text>
						</view>
						<view class="like_img">
							<!-- <image :src="pic" v-for="pic in item.imgUrl"></image> -->
							<img style="width: 90rpx; height: 90rpx;" src="https://qyapi.cuixiaoler.com:1002/static/default.jpg" alt="" srcset="">
						</view>
					</view>
				</view>
			</view>
