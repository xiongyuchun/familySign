...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"familySign","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 38 */
/*!******************************************************************!*\
  !*** D:/家庭签约/familySign/pages.json?{"type":"origin-pages-json"} ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 39 */
/*!*****************************************************!*\
  !*** D:/家庭签约/familySign/pages.json?{"type":"stat"} ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 40 */
/*!******************************************************!*\
  !*** D:/家庭签约/familySign/pages.json?{"type":"style"} ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 47 */
/*!*****************************************!*\
  !*** D:/家庭签约/familySign/store/index.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = new _vuex.default.Store({
  ...
  actions: {
    ...
    // 用户绑定
    userBind: function userBind(_ref6, client_id) {
    ...
    // 获取未读信息
    getUnreadMessages: function getUnreadMessages(_ref7) {
    ...
    // 初始化会话列表
    initChatList: function initChatList(_ref8) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                state = _ref8.state, dispatch = _ref8.dispatch, commit = _ref8.commit;
                _context.next = 3;
                return dispatch('getChatList');
              case 3:
                state.chatList = _context.sent;
    ...
    // 处理接收消息
    handleChatMessage: function handleChatMessage(_ref9, data) {
    ...
    // 更新聊天会话列表
    updateChatList: function updateChatList(_ref10, _ref11) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var state, dispatch, commit, data, send, isMySend, chatList, i, obj, item;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                state = _ref10.state, dispatch = _ref10.dispatch, commit = _ref10.commit;
                data = _ref11.data, send = _ref11.send;
              ...
              case 7:
                ...
                _context2.next = 12;
                return dispatch('formatChatListObject', {
                  data: data,
                  send: send
                });
              case 12:
              ...
              case 18:
                ...
                // 置顶当前会话
                chatList = _util.default.__toFirst(chatList, i);
              case 25:
                // 存储到本地存储
                ...
                _context2.next = 30;
                return dispatch('updateTabbarBadge');
              case 30:
              case "end":
                return _context2.stop();
            }
    ...
    // 获取所有聊天会话列表
    getChatList: function getChatList(_ref12) {
      var state = _ref12.state;
      var list = uni.getStorageSync('chatlist_' + state.user.id);
      return list ? JSON.parse(list) : [];
    },
    // 获取与某个用户聊天内容列表
    getChatDetailToUser: function getChatDetailToUser(_ref13) {
      var state = _ref13.state;
      var toId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      // chatdetail_[当前用户id]_[聊天对象id]
      var myId = state.user.id;
      toId = toId ? toId : state.ToUser.user_id;
      var key = 'chatdetail_' + myId + '_' + toId;
    ...
    // 消息转聊天会话对象
    formatChatListObject: function formatChatListObject(_ref14, _ref15) {
    ...
    // 消息转对话对象
    formatChatDetailObject: function formatChatDetailObject(_ref16, e) {
    ...
    // 更新未读数
    updateTabbarBadge: function updateTabbarBadge(_ref17) {
    ...
    // 更新与某个用户聊天内容列表
    updateChatDetailToUser: function updateChatDetailToUser(_ref18, e) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
        var state, dispatch, commit, data, toId, list;
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                state = _ref18.state, dispatch = _ref18.dispatch, commit = _ref18.commit;
                console.log('更新与某个用户聊天内容列表', e);
                data = e.data;
                toId = e.send ? state.ToUser.user_id : data.from_id; // 获取与某个用户聊天内容的历史记录
                _context3.next = 6;
                return dispatch('getChatDetailToUser', toId);
              case 6:
                list = _context3.sent;
                _context3.t0 = list;
                _context3.next = 10;
                return dispatch('formatChatDetailObject', e);
              case 10:
    ...
    // 发送消息
    sendChatMessage: function sendChatMessage(_ref19, data) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var dispatch, sendData;
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                */
                ...
                // 组织发送消息格式
                _context4.next = 4;
                return dispatch('formatSendData', data);
              case 4:
                ...
                */
                ...
                return _context4.abrupt("return", sendData);
              case 9:
              case "end":
                return _context4.stop();
            }
    ...
    // 组织发送格式
    formatSendData: function formatSendData(_ref20, data) {
    ...
    readChatMessage: function readChatMessage(_ref21, item) {
...
/* 49 */
/*!*******************************************!*\
  !*** D:/家庭签约/familySign/common/config.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 50 */
/*!********************************************!*\
  !*** D:/家庭签约/familySign/common/request.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!*****************************************!*\
  !*** D:/家庭签约/familySign/common/util.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function pathToBase64(path) {
  var promise = new Promise(function (resolve, reject) {
    uni.getFileSystemManager().readFile({
      ...
      //编码格式
      success: function success(res) {
        var data = "data:image/jpg" + ";base64," + res.data; //base64地址
        resolve(data);
      },
