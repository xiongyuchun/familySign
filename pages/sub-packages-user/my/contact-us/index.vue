<template>
	<view class="">
		<my-navbar title="联系我们"></my-navbar>
		<view class="px-3">
			<map style="width: 100%; height: 300px;margin-top: 70rpx;" :latitude="latitude"
			...
			<view class="map-info">
				...
				<view class="map-info-item flex align-center">
					<img src="https://qyapi.cuixiaoler.com:1002/static/my/map.png" alt="" srcset="" style="width: 33rpx; height: 43rpx;">
