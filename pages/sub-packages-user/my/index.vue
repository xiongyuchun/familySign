	...
	<view class="my">
		<special-navbar>
			<view class="flex flex-column" style="position: relative;">
				...
				<view class="navbar-info flex">
					<view class="navbar-info_photo"><img src="https://qyapi.cuixiaoler.com:1002/static/default.jpg" class="navbar-info_photo_img" alt="" srcset=""></view>
		...
		<view class="my-list shadow">
			<view @click="$U.gotoPage('/pages/sub-packages-user/my/upload-info/index?type=info')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/info.png" alt="">
			...
			<view @click="$U.gotoPage('/pages/sub-packages-user/my/upload-info/index')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/bind-user.png" alt="">
			...
			<view @click="$U.gotoPage('/pages/sub-packages-user/my/add-file/index')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/index/uploadInfo.png" alt="">
			...
			<view  @click="$U.gotoPage('/pages/sub-packages-user/my/review-file/index')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/review.png" alt="">
			...
			<view @click="$U.gotoPage('/pages/sub-packages-user/my/contact-us/index')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/email.png" style="height: 30rpx;" alt="">
			...
			<view @click="$U.gotoPage('/pages/sub-packages-user/my/about/index')" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/about.png" alt="">
			...
			<view @click="logout" class="my-list-item flex align-center justify-between">
				<view class="flex align-center">
					<img class="my-list-item_img" src="https://qyapi.cuixiaoler.com:1002/static/my/logout.png" alt="">
