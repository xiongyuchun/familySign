<template>
	<view class="">
		<view class="doctor-top">
			<img class="doctor-top-bg" src="https://jtysqy.cuixiaoler.com:1703/static/index/doctor-bg.png" alt="" srcset="">
			<!-- 状态栏 -->
		...
		<view class="px-3">
			<view class="px-3 bg-white icon-list flex my-3 grid-shadow">
				...
				<view @click="$U.gotoPage('/pages/sub-packages-doctor/my/statistics-manage/index')" class="flex flex-column justify-center align-center">
					<img src="https://jtysqy.cuixiaoler.com:1703/static/index/tongji.png" alt="" srcset="" style="width: 85rpx; height: 90rpx;">
